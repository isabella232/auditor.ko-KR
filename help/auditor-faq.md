...
* [Adobe Experience Platform 감사원이란?](auditor-faq.md#section-c4a9bc8d8eef41598c27e0951a2518e4)
* [우리 회사는 Platform Auditor를 사용할 수 있습니까?](auditor-faq.md#section-f90094050d1e44929066a942833435cf)
...
* [플랫폼 감사자가 Adobe 이외 기술을 감사할 수 있습니까?](auditor-faq.md#section-f6e73c56083b4815bbf901296038bcd4)
* [IP 주소를 허용 목록에 추가하여 페이지를 승인할 수 있습니까?](auditor-faq.md#section-011e4f54c58140ffb93bedeb0745b6cc)
* [플랫폼 감사자가 Observepoint와 동일한 IP 범위를 사용합니까?](auditor-faq.md#section-39512b156e194787981bdd572ff5b5a9)

## Adobe Experience Platform 감사원이란? {#section-c4a9bc8d8eef41598c27e0951a2518e4}

Platform Auditor는 ObservePoint와 함께 개발하여 디지털 구현을 검증하는 데 있어 전문가들이 함께 개발한 Adobe Experience Cloud의 서비스입니다.

Platform Auditor를 사용하면 고객은 한 번에 최대 500개의 웹 페이지를 스캔할 수 있으며, Adobe Experience Cloud 구현을 개선하는 방법을 보여주는 보고서를 받아 Adobe 투자 가치를 극대화할 수 있습니다.

## Am I eligible to use Platform Auditor? {#section-f90094050d1e44929066a942833435cf}

모든 Adobe Experience Cloud 고객 조직은 Platform Auditor(2018년 5월 1일)에 대한 무료 액세스 권한이 부여됩니다. 각 사용자는 기능에 액세스하기 전에 Adobe Experience Cloud UI에서 Adobe/ObservePoint 사용 약관에 동의해야 합니다. 약관에 동의하지 않으려면 계정 관리자에게 문의하십시오.

## How do I access Platform Auditor? {#section-531ff85f94384831a89cbb4109549daf}

After logging in at [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com), you can find Platform Auditor by clicking on **[!UICONTROL Activation]** in the top navigation. [https://auditor.adobe.com](https://auditor.adobe.com)으로 바로 이동할 수도 있습니다.
...
>[!NOTE]
>
>Platform Auditor는 한 번에 하나의 검색을 실행합니다. 전체 ObservePoint 계정은 여러 개의 감사를 연속해서 실행할 수 있습니다.
...
Platform Auditor를 통해 제공되는 모든 권장 사항은 DTM 또는 Target과 같은 Adobe Experience Cloud 솔루션 구현의 문제를 해결하기 위한 조치를 취할 수 있도록 돕기 위한 것입니다. 이를 위해 Platform Auditor 팀은 다양한 방식으로 작업하여 어디에서나 수행해야 하는 작업에 대한 세부적인 지침을 제공하고 있습니다. 검사한 모든 URL과 테스트 결과를 스프레드시트로 내보내 문제 영역을 쉽게 찾아낼 수 있습니다. 다음은 DTM 구현을 위한 권장 사항의 한 가지 예시입니다.
...
아니요. 그러나 ObservePoint의 전체 솔루션을 사용하면 모든 마케팅 태그와 기술을 감사 및 모니터링할 수 있습니다. Adobe 고객은 무료 체험판 계정을 이용할 수 있습니다. To access your trial account visit [ObservePoint’s Platform Auditor Page](https://www.observepoint.com/adobe-auditor/?utm_source=Adobe&amp;utm_medium=Auditor&amp;utm_campaign=Premium).
