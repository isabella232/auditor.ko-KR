...
이 참조는 Adobe Experience Platform Auditor에서 태그가 있는지 확인하기 위해 수행하는 테스트에 대한 자세한 정보를 제공합니다.
...
<table id="table_98A2E3F7B3154EEFA76D0CAE2FE97CAB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 전역 _satellite 개체를 DOM에서 찾을 수 없습니다. Platform Launch가 설치되지 않거나 실행되지 않습니다. </p> </td> 
